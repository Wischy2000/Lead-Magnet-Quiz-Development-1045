      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex items-start gap-3">
          ...
          <label htmlFor="consent" className="text-sm text-white/80 leading-relaxed">
            Ich stimme zu, dass meine E-Mail-Adresse gespeichert und für das Zusenden der personalisierten Tipps verwendet wird. Die Daten werden vertraulich behandelt und nicht an Dritte weitergegeben.
          </label>
        </div>
